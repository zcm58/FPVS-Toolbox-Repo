...
- `src/Tools/Free_Harmonic_Clustering/`: GUI-neutral headless backend for
  clean-room Free Harmonic Clustering Analysis. It reads original managed
  ...
  two-level cluster-permutation contrast. It is separate from locked Standard
  FPVS Screening and does not consume Stats-ready Summed BCA exports. See its
