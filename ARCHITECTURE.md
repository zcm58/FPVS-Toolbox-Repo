...
- `src/Main_App/gui/`: canonical Main App GUI import surface. It owns focused GUI workflow helpers such as project open/create/save orchestration and post-export completion handling, and delegates remaining main-window, settings-panel, menu, sidebar, icon, style-token, and update-manager imports to the existing PySide6 GUI implementation.
