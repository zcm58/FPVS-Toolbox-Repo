"""Provide the stats qc reports features for the Stats workflow."""
...
def _coerce_fixed_dv_table(dv_table: pd.DataFrame) -> pd.DataFrame:
    """Handle the coerce fixed dv table step for the Stats workflow."""
...
def export_qc_context_workbook(
    *,
    ...
    """Handle the export qc context workbook step for the Stats workflow."""
