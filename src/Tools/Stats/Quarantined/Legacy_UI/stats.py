...
from Tools.Stats.Legacy.stats_file_scanner import (
    browse_folder,
    scan_folder,
    update_condition_menus,
    update_condition_B_options,
)
...
if __name__ == "__main__":
    try:
        ...
        from Tools.Stats.Legacy import stats_export
        from Tools.Stats.Legacy.repeated_m_anova import run_repeated_measures_anova
