...
class PlotGeneratorUiSectionsMixin:
    ...
    def _build_ui(self) -> None:
        ...
        self.session_error_label = QLabel()
        self.session_error_label.setObjectName("snr_session_error")
        self.session_error_label.setWordWrap(True)
        self.session_error_label.setProperty("caption", True)
        self.session_error_label.hide()
        session_grid.addWidget(self.session_error_label, 3, 0, 1, 4)
