...
| Wave 2: analyzed-interval signal QC | In progress | QC-01/QC-05/QC-06/QC-08/QC-09 are implemented, including 5-second/50%-overlap review evidence and exact exclusion of non-analyzed conditions. QC-04 now separates the optional experimental detector from manual channel authority and defaults unresolved projects to an explicit Off choice. QC-16's evidence, authority, cache, report, and fail-closed processing gate are implemented; its GUI scan/review integration remains. QC-18 final spectral eligibility integration remains. |
| Wave 3: outcomes and integrity | In progress | Truthful preprocessing outcomes, QC-07 burden calculation and explicit >5% downstream review, QC-10 integrity primitives, and QC-20 recording-condition receipt reconciliation are implemented with focused tests. Final spectral-writer integration and cross-gate validation remain. |
| Wave 4: frequency and ROI finalization | In progress | The shared project-filter-derived eligibility and noise-support implementation is under combined verification. Frequency review, fixed ROI coverage, and final readiness ordering still require integrated validation. |
