...
2. `docs/agent/architecture/statistics-tools.md`
...
- Status: active.
- Files changed: `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/gui.py`; `src/Tools/Plot_Generator/plot_generator.py`; `tests/test_plot_generator_condition_title_all.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/project_paths.py`; `src/Tools/Plot_Generator/gui.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/gui_settings.py`; `src/Tools/Plot_Generator/gui.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/settings_dialog.py`; `src/Tools/Plot_Generator/gui.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/selection_state.py`; `src/Tools/Plot_Generator/gui.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/generation_workflow.py`; `src/Tools/Plot_Generator/gui.py`; `src/Tools/Plot_Generator/plot_generator.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
...
- Status: complete.
- Files changed: `src/Tools/Plot_Generator/ui_sections.py`; `src/Tools/Plot_Generator/gui.py`; `docs/agent/exec-plans/active/plot-generator-gui-refactor.md`.
