...
This page keeps the detailed processing information separate from the beginner-friendly [Processing Pipeline](processing-pipeline.md) overview. Fill in the placeholders with values from your project settings, manifest, and processing logs.
