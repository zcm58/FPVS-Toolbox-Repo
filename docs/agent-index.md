...
| Post-processing or Excel export behavior | `legacy-boundary-review`; add `pyside6-gui-cleanup` for GUI completion handling | `.agents/skills/legacy-boundary-review/scripts/audit_protected_edits.py` | `docs/architecture/post-processing-export-contract.md`; GUI wrapper: `src/Main_App/gui/post_export_workflows.py` |
