...
| Stats package structure, compatibility shims, analysis organization | `pyside6-gui-cleanup` | `scripts/agent_audit.py --check stats-pyside6` | `docs/architecture/statistics-tools.md` |
