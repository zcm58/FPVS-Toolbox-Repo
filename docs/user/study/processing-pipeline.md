...
4. Open [Statistical Analysis Overview](../results/statistical-analysis.md) to choose the next analysis step.
5. Use [Which Statistical Test Should I Use?](../statistics/which-test.md) if you are unsure which test fits your dataset.

For manuscript wording and detailed reporting values, use [Methods Reporting Checklist](../reference/methods-reporting-checklist.md).
