...
Use this page when you need manuscript-ready Methods wording or a checklist of processing details to report.

This page keeps the detailed processing information separate from the beginner-friendly [Processing Pipeline](../study/processing-pipeline.md) overview. Fill in the placeholders with values from your project settings, manifest, and processing logs.
...
Let:
- `A` = amplitude at the target FFT bin (uV)
...
- **Exported metrics and units:** [SNR, Z, BCA (uV), FFT amplitude (uV)]
