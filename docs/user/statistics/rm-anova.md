...
Use this page when your repeated-measures dataset is complete and you need details about RM-ANOVA reporting.
...
condition x ROI combination. If that's true, RM-ANOVA provides a clean,
...
interaction (Condition x ROI). RM-ANOVA was implemented using
...
contributed observations for all required condition x ROI combinations;
