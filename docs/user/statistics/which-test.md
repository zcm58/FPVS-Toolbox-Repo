...
| Which harmonics should contribute to Summed BCA? | You are using the Rossion-style harmonic workflow. | Rossion harmonic selection | Harmonic set used to build the dependent variable. |
...
| You need to justify which oddball harmonics were included. | Run Rossion harmonic selection and archive the DV definition export. |
