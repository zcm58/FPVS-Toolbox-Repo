...
Use this page when you want participant-level detectability figures or diagnostics.
...
- `USE_LETTER_PORTRAIT = True` produces an 8.5x11 in figure with reserved title and colorbar bands.
