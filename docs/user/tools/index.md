...
| --- | --- |---------------------------------------------------------------------------------------------------|
| [Statistics](statistics.md) | Default | Run basic statistical tests quickly from inside FPVS Toolbox.                                     |
| [SNR Plot Generator](snr-plot-generator.md) | Default | Create SNR plots for each of your conditions.                                                     |
