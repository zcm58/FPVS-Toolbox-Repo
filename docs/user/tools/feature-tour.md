...
| LORETA Visualizer | Displays an experimental 3D brain mesh with synthetic source-map overlays | When validating source-visualization rendering before real source localization is added | Interactive viewport only |
