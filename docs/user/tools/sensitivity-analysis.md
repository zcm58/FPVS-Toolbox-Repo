...
Enter the sample size, number of repeated measurements, desired power, alpha,
average correlation among repeated measurements, and nonsphericity correction
epsilon. The result is the minimum detectable Cohen's *f* and its equivalent
eta-squared value.
