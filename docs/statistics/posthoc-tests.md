...
Use this page when you need to interpret or report condition-pair comparisons within each ROI.
...
If the repeated-measures ANOVA finds a **Condition x ROI interaction**,
...
Following detection of a significant Condition x ROI interaction in the
