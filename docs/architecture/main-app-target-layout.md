...
owns project workflow orchestration and GUI-side post-export completion
handling, and delegates remaining main-window, settings-panel, menu, sidebar,
icon, style-token, and update-manager implementations while GUI smoke tests
protect behavior.
